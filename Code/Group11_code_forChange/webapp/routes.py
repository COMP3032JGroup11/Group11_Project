...
def index():
    ...
    if not db.session.query(District).first():
        ...
        #                  ]
        district_list = ['ChangPing', 'ChaoYang', 'DaXing', 'DongCheng', 'FangShan', 'FengTai', 'HaiDian', 'HuaiRou',
                         'MenTouGou',
                         'MiYun', 'PingGu', 'ShiJingShan', 'ShunYi', 'TongZhou', 'XiCheng', 'YanQing', 'YiZhuangKaiFaqu'
                         ]
    ...
    if not db.session.query(Community).first():
        ...
        #                   '延庆其它']
        community_list = ['XiGuanHuanDao', 'BeiQiJia', 'HuoYing', 'GuLouDaJie', 'HuiLongGuan', 'XiSanQi', 'DongGuan',
                          'TianTongYuan',
                          'ShaHe', 'NanShao', 'ChangPing Other', 'XiaoTangShan', 'LiShuiQiao', 'AoLinPiKeGongYuan',
                          'NanKou', 'AnNingZhuang',
                          'DingFuZhuang', 'YaYunCunXiaoYing', 'DouGeZhuang', 'ShuangQiao', 'ChangYing', 'ShouDuJiChang',
                          'GuanZhuang', 'ShiLiHe',
                          'ShaoYaoJu', 'FaTou', 'HePingLi', 'YaYunCun', 'HongMiao', 'ShiFoYing', 'ChaoYang Other',
                          'GuoZhan',
                          'DongBa', 'GongTi', 'PanJiaYuan', 'SanYuanQiao', 'BeiYuan', 'HuaWeiQiao', 'ShiLiBao', 'CBD',
                          'HuiXinXiJie',
                          'ShiBaLiDian', 'JiuXianQiao', 'JinSong', 'BaiZiWan', 'FangZhuang', 'ChaoQin', 'WangJing',
                          'HuanLeGu', 'ZhongYangBieShuQu',
                          'GanLuYuan', 'SiHui', 'BeiGongDa', 'ChengShouSi', 'GaoBeiDian', 'DaWangLu', 'TaiYangGong',
                          'ShuangJing', 'TuanJieHu',
                          'NanShaTan', 'DongDaQiao', 'TianShuiYuan', 'XiBaHe', 'JianXiangQiao', 'SanLiTun', 'AnZhen',
                          'LiangMaQiao', 'WeiZhi',
                          'DaShanZi', 'JianGuoMenWai', 'ChaoYangMenWai', 'DongZhiMen', 'NongZhanGuan',
                          'ChaoYangGongYuan', 'MaDian', 'YanSha',
                          'AnDingMen', 'NanZhongZhouJiChangShangWuQu', 'GaoMiDian', 'HuangCunHuoCheZhan', 'ZaoYuan',
                          'HuangCunZhong', 'XiHongMen',
                          'DaXing Other', 'YingHai', 'TianGongYuan', 'YiHeZhuang', 'DaXingXinJiChang', 'KeJiYuanQu',
                          'JiuGong', 'GuanYinSi',
                          'YiZhuang', 'YiZhuangKaiFaQu Other', 'HeYi', 'DaXingXinJiChangYangFangBieShuQu',
                          'TianGongYuanNan', 'YongDingMen', 'ChongWenMen',
                          'DongHuaShi', 'GuangQuMen', 'TaoRanTing', 'ZuoAnMen', 'DongSi', 'JianGuoMenNei', 'TianTan',
                          'QianMen', 'DiAnMen', 'DengShiKou',
                          'JinBaoJie', 'JiaoDaoKou', 'ChaoYangMenNei', 'PuHuangYu', 'DongDan', 'ChangYang',
                          'LiangXiang', 'YanCun', 'ChengGuan', 'YanShan',
                          'FangShan Other', 'DouDian', 'QingTa', 'XinGong', 'MuXiYuan', 'HuaXiang', 'MaJiaBao',
                          'XiLuoYuan', 'LuGouQiao', 'BeiDaDi',
                          'DaHongMen', 'KanDanQiao', 'YangQiao', 'YuQuanYing', 'LiuJiaYao', 'WuLiDian', 'ZhaoGongKou',
                          'SongJiaZhuang', 'YouAnMenWai', 'JiaoMen',
                          'LiuLiQiao', 'QiLiZhuang', 'FengTai Other', 'LiZe', 'CaoQiao', 'BeiJingNanZhan',
                          'TaiPingQiao', 'CaiHuYing', 'MaLianDao', 'YueGeZhuang',
                          'WuKeSong', 'GuangAnMen', 'MaLianWa', 'XiShan', 'DingHuiSi', 'HaiDianBeiBuXinQu', 'JunBo',
                          'ShangDi', 'QingHe', 'ChangWa',
                          'ZiZhuQiao', 'GanJiaKou', 'GongZhuFen', 'YuQuanLu', 'TianCun', 'XiaoXiTian', 'WanShouLu',
                          'XiZhiMen', 'ErLiZhuang', 'ZaoJunMiao',
                          'ShuangYuShu', 'SiJiQing', 'XinJieKou', 'SuZhouQiao', 'YiHeYuan', 'ZhiChunLu', 'WuDaoKou',
                          'YuanMingYuan', 'MuDanYuan', 'XiBeiWang',
                          'XueYuanLu', 'WanLiu', 'ZhongGuanCun', 'XiErQi', 'YangZhuang', 'WeiGongCun', 'ShiJiCheng',
                          'BaiShiQiao', 'BeiTaiPingZhuang', 'HaiDian Other',
                          'HuaiRou', 'DaYu', 'ShiMenYing', 'ChengZi', 'BinHeXiQu', 'FengCun', 'MenTouGou Other',
                          'MiYun Other', 'PingGu Other', 'LuGu',
                          'BaJiao', 'PingGuoYuan', 'ShiJingShan Other', 'GuCheng', 'LaoShan', 'MaPo', 'ShunYi Other',
                          'ShunYiCheng', 'HouShaYu', 'TianZhu',
                          'LiQiao', 'QiaoZhuang', 'BeiGuan', 'WanDa', 'LinHeLi', 'WuYiHuanYuan', 'GuoYuan', 'YuQiao',
                          'LiYuan', 'JiuKeShu(JiaLeFu)',
                          'LuYuan', 'TongZhouBeiYuan', 'TongZhou Other', 'MaJuQiao', 'JinRongJie', 'NiuJie',
                          'YouAnMenNei', 'MuXiDi', 'XiDan', 'ChangChunJie',
                          'YueTan', 'CheGongZhuang', 'FuChengMen', 'TianNingSi', 'XuanWuMen', 'GuanYuan', 'BaiZhiFang',
                          'LiuPuKang', 'DeShengMen', 'XiSi',
                          'YanQing Other']
...
def customer_index():
    ...
    if not session.get("USERNAME") is None:
        ...
        if not db.session.query(District).first():
            ...
            #                  '密云', '平谷', '石景山', '顺义', '通州', '西城', '延庆', '亦庄开发区'
            #                  ]
            district_list = ['ChangPing', 'ChaoYang', 'DaXing', 'DongCheng', 'FangShan', 'FengTai', 'HaiDian',
                             'HuaiRou', 'MenTouGou',
                             'MiYun', 'PingGu', 'ShiJingShan', 'ShunYi', 'TongZhou', 'XiCheng', 'YanQing',
                             'YiZhuangKaiFaqu'
                             ]
            for index in range(len(district_list) + 1):
                if index == 0:
        ...
        if not db.session.query(Community).first():
            ...
            #                   '月坛', '车公庄', '阜成门', '天宁寺', '宣武门', '官园', '白纸坊', '六铺炕', '德胜门', '西四',
            #                   '延庆其它']
            community_list = ['XiGuanHuanDao', 'BeiQiJia', 'HuoYing', 'GuLouDaJie', 'HuiLongGuan', 'XiSanQi',
                              'DongGuan', 'TianTongYuan',
                              'ShaHe', 'NanShao', 'ChangPing Other', 'XiaoTangShan', 'LiShuiQiao', 'AoLinPiKeGongYuan',
                              'NanKou', 'AnNingZhuang',
                              'DingFuZhuang', 'YaYunCunXiaoYing', 'DouGeZhuang', 'ShuangQiao', 'ChangYing',
                              'ShouDuJiChang', 'GuanZhuang', 'ShiLiHe',
                              'ShaoYaoJu', 'FaTou', 'HePingLi', 'YaYunCun', 'HongMiao', 'ShiFoYing', 'ChaoYang Other',
                              'GuoZhan',
                              'DongBa', 'GongTi', 'PanJiaYuan', 'SanYuanQiao', 'BeiYuan', 'HuaWeiQiao', 'ShiLiBao',
                              'CBD', 'HuiXinXiJie',
                              'ShiBaLiDian', 'JiuXianQiao', 'JinSong', 'BaiZiWan', 'FangZhuang', 'ChaoQin', 'WangJing',
                              'HuanLeGu', 'ZhongYangBieShuQu',
                              'GanLuYuan', 'SiHui', 'BeiGongDa', 'ChengShouSi', 'GaoBeiDian', 'DaWangLu', 'TaiYangGong',
                              'ShuangJing', 'TuanJieHu',
                              'NanShaTan', 'DongDaQiao', 'TianShuiYuan', 'XiBaHe', 'JianXiangQiao', 'SanLiTun',
                              'AnZhen', 'LiangMaQiao', 'WeiZhi',
                              'DaShanZi', 'JianGuoMenWai', 'ChaoYangMenWai', 'DongZhiMen', 'NongZhanGuan',
                              'ChaoYangGongYuan', 'MaDian', 'YanSha',
                              'AnDingMen', 'NanZhongZhouJiChangShangWuQu', 'GaoMiDian', 'HuangCunHuoCheZhan', 'ZaoYuan',
                              'HuangCunZhong', 'XiHongMen',
                              ...
                              'YiZhuang', 'YiZhuangKaiFaQu Other', 'HeYi', 'DaXingXinJiChangYangFangBieShuQu',
                              'TianGongYuanNan', 'YongDingMen', 'ChongWenMen',
                              'DongHuaShi', 'GuangQuMen', 'TaoRanTing', 'ZuoAnMen', 'DongSi', 'JianGuoMenNei',
                              'TianTan', 'QianMen', 'DiAnMen', 'DengShiKou',
                              'JinBaoJie', 'JiaoDaoKou', 'ChaoYangMenNei', 'PuHuangYu', 'DongDan', 'ChangYang',
                              'LiangXiang', 'YanCun', 'ChengGuan', 'YanShan',
                              'FangShan Other', 'DouDian', 'QingTa', 'XinGong', 'MuXiYuan', 'HuaXiang', 'MaJiaBao',
                              'XiLuoYuan', 'LuGouQiao', 'BeiDaDi',
                              'DaHongMen', 'KanDanQiao', 'YangQiao', 'YuQuanYing', 'LiuJiaYao', 'WuLiDian',
                              'ZhaoGongKou', 'SongJiaZhuang', 'YouAnMenWai', 'JiaoMen',
                              'LiuLiQiao', 'QiLiZhuang', 'FengTai Other', 'LiZe', 'CaoQiao', 'BeiJingNanZhan',
                              'TaiPingQiao', 'CaiHuYing', 'MaLianDao', 'YueGeZhuang',
                              'WuKeSong', 'GuangAnMen', 'MaLianWa', 'XiShan', 'DingHuiSi', 'HaiDianBeiBuXinQu', 'JunBo',
                              'ShangDi', 'QingHe', 'ChangWa',
                              ...
                              'HuaiRou', 'DaYu', 'ShiMenYing', 'ChengZi', 'BinHeXiQu', 'FengCun', 'MenTouGou Other',
                              'MiYun Other', 'PingGu Other', 'LuGu',
                              'BaJiao', 'PingGuoYuan', 'ShiJingShan Other', 'GuCheng', 'LaoShan', 'MaPo',
                              'ShunYi Other', 'ShunYiCheng', 'HouShaYu', 'TianZhu',
                              'LiQiao', 'QiaoZhuang', 'BeiGuan', 'WanDa', 'LinHeLi', 'WuYiHuanYuan', 'GuoYuan',
                              'YuQiao', 'LiYuan', 'JiuKeShu(JiaLeFu)',
                              'LuYuan', 'TongZhouBeiYuan', 'TongZhou Other', 'MaJuQiao', 'JinRongJie', 'NiuJie',
                              'YouAnMenNei', 'MuXiDi', 'XiDan', 'ChangChunJie',
                              'YueTan', 'CheGongZhuang', 'FuChengMen', 'TianNingSi', 'XuanWuMen', 'GuanYuan',
                              'BaiZhiFang', 'LiuPuKang', 'DeShengMen', 'XiSi',
                              'YanQing Other']
            for index in range(len(community_list) + 1):
                if index == 0:
                    continue
